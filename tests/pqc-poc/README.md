...
## Overview
This directory contains a functional Proof of Concept (PoC) for the **ANS Hybrid Identity** architecture. It demonstrates the integration of **NIST ML-DSA (Dilithium)** signatures alongside classical **ECDSA** signatures.
...
## Dependencies
*   `dilithium-crystals`: A WASM compilation of the reference C implementation of CRYSTALS-Dilithium.
*   `crypto`: Node.js standard library for classical ECDSA operations.
